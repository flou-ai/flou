...
class WritingInstructions(BaseModel):
    writing_instructions: str = Field(..., description="Instructions for writing the bedtime story")
...
class BedtimeStoryWriter(LTM):
    ...
    # Define payload schemas for transitions by label
    transition_payloads = {
